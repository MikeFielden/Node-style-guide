...
## Arrays
  ...
  - Always use Array#push unless you want it at a particular location
    ...
    // bad
    someStack[someStack.length] = 'stringy string';

    // good
    someStack.push('stringy string');
    ```
...
## Strings
  ...
  - Use single quotes `''` for strings
    ...
    ```javascript
    // bad
    var name = "Billy Madison";

    // good
    var name = 'Billy Madison';

    // bad
    var fullName = "Billy " + this.lastName;
...
## Functions
  ...
  - Function expressions:
    ...
    (function () {
      console.log('Welcome to the Thunderdome. Please follow me.');
    })();
    ```
...
## Callbacks
  ...
  //good
  database.get('items', function (err, data) {
    if (err) {
      cb(err);
    }
...
## Whitespace
  ...
  - Place 1 space before the leading brace and before ()
